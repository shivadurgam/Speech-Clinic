...
class SlotsControllerTest < ActionController::TestCase
  ...
  test "should create slot" do
    assert_difference('Slot.count') do
      post :create, slot: { slot1: @slot.slot1, slot2: @slot.slot2, slot3: @slot.slot3, slot4: @slot.slot4 }
    end
  ...
  test "should update slot" do
    patch :update, id: @slot, slot: { slot1: @slot.slot1, slot2: @slot.slot2, slot3: @slot.slot3, slot4: @slot.slot4 }
    assert_redirected_to slot_path(assigns(:slot))
  end
